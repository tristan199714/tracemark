...
DATASET_PATHS = {
    ...
    'CelebA_HQ': os.path.join(BASE_DATA_ROOT, 'celeba_hq'),
    'AFHQ': os.path.join(BASE_DATA_ROOT, 'afhq'),
    'LSUN': os.path.join(BASE_DATA_ROOT, 'lsun'),
    'IMAGENET': os.path.join(BASE_DATA_ROOT, 'imagenet'),
}
